import{_ as p,o as l,c as e,ag as n,j as s,a as i}from"./chunks/framework.C63nTIu3.js";const d=JSON.parse('{"title":"Prompt工程","description":"","frontmatter":{},"headers":[],"relativePath":"ai/chapter-03.md","filePath":"ai/chapter-03.md","lastUpdated":1770223086000}'),t={name:"ai/chapter-03.md"};function h(r,a,k,c,b,u){return l(),e("div",null,[...a[0]||(a[0]=[n(`<h1 id="prompt工程" tabindex="-1">Prompt工程 <a class="header-anchor" href="#prompt工程" aria-label="Permalink to &quot;Prompt工程&quot;">​</a></h1><h2 id="本章导读" tabindex="-1">本章导读 <a class="header-anchor" href="#本章导读" aria-label="Permalink to &quot;本章导读&quot;">​</a></h2><p><strong>Prompt Engineering（提示词工程）</strong> 是AI应用开发中最重要的技能之一。好的提示词能让AI发挥出强大能力，而不好的提示词则会导致模糊、不准确的回答。</p><p>本章将系统介绍如何设计高效的提示词，让你的AI应用效果提升10倍！</p><p><strong>学习目标</strong>：</p><ul><li>理解Prompt Engineering的核心原则</li><li>掌握常用的提示词模式</li><li>学习Few-shot Learning技巧</li><li>实现高级提示词策略</li></ul><p><strong>预计学习时间</strong>：50分钟</p><hr><h2 id="什么是prompt-engineering" tabindex="-1">什么是Prompt Engineering？ <a class="header-anchor" href="#什么是prompt-engineering" aria-label="Permalink to &quot;什么是Prompt Engineering？&quot;">​</a></h2><h3 id="prompt-engineering的定义" tabindex="-1">Prompt Engineering的定义 <a class="header-anchor" href="#prompt-engineering的定义" aria-label="Permalink to &quot;Prompt Engineering的定义&quot;">​</a></h3><p><strong>Prompt Engineering</strong> 是指通过设计和优化输入给大语言模型的提示词，以引导模型生成更准确、更相关、更符合预期的输出的技术。</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>┌─────────────────────────────────────────┐</span></span>
