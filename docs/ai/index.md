...
📖 拓展（第13章）[⏱️ 2小时 | ⭐⭐⭐ 高级]
   ├─ 主流LLM模型对比
   ├─ 本地模型部署（Ollama、Llama 3.1）
   ├─ LangGraph复杂Agent框架
   ├─ MCP协议（Model Context Protocol）
   └─ AI应用评估和测试

总计学习时间：约 16-18小时（建议3-4周完成）
```
...
- [第8章：2026 Agent Skills](chapter-08-agent-skills) - 多Agent协作框架（CrewAI、AutoGen、Semantic Kernel）

### 模块 3：企业级实战项目（3 章）

- [第9章：AI 完全实战项目 - 企业级智能客服系统](chapter-08) - 完整项目实战
- [第10章：AI 完全实战项目 - 企业级数据分析与商业智能平台](chapter-09) - 数据分析平台
- [第11章：AI 完全实战项目 - 多模态内容生成与管理平台](chapter-10) - 多模态平台

### 模块 4：拓展（1 章）

- [第13章：应用进阶](chapter-07) - 高级主题与最佳实践
